package com.hrt.cloud.app.user.util;
...
public class MysqlCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3307/hrt_user?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
        ...
        pc.setParent("com.hrt.cloud.app.user");
        pc.setMapper("mapper");
